...
## Написание бота
Логику и то, какие команды отправлять, необходимо прописывать в классе **MyCustomLoderunnerAI**, в методе **DoMove**, которые описаны в файле **MyCustomLoderunnerAI.cs**:
