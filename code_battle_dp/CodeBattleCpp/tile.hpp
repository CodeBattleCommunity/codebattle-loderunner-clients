...
public:
	...
	bool cant_step_on() {
		return id_ == tile::NONE || id_ == tile::PIPE || is_gold() || is_enemy_bot() /*|| is_me()*/|| id_ == tile::HERO_DRILL_LEFT || id_ == tile::HERO_RIGHT
			|| id_ == tile::HERO_DRILL_RIGHT || id_ == tile::HERO_FALL_LEFT || id_ == tile::HERO_FALL_RIGHT || id_ == tile::HERO_LEFT || id_ == tile::HERO_PIPE_LEFT || id_ == tile::HERO_PIPE_RIGHT;
	}
	tile_type_ get_type() {
